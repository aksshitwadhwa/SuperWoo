 ...
 * Update URI: https://digtize.com/plugins/superwoo/
...
define('SUPERWOO_VERSION', '1.0.213');
...
require_once SUPERWOO_PATH . 'includes/class-shop-filters.php';
require_once SUPERWOO_PATH . 'includes/class-shoppable-videos.php';
